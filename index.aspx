                    ...
                    <div class="abt-form text-center">
                        <form action="#" method="post">
                            <div class="col-sm-4 col-xs-4 w3ls-lt-form">
                                <div class="w3ls-pr">
                                    <asp:DropDownList class="sel" ID="DropDownList1" runat="server">
                            ...
                            <div class="col-sm-4 col-xs-4 w3ls-lt-form">
                                <div class="w3ls-pr">
                                    <asp:TextBox ID="TextBox2" runat="server" placeholder="Date" TextMode="Date" required="required"></asp:TextBox>
                            ...
                            <div class="col-sm-4 col-xs-4 w3ls-lt-form">
                                <div class="w3ls-pr">
                                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Time" TextMode="Time"></asp:TextBox>
