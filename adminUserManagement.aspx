         ...
         <div class="col-md-6">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eventConnectionString %>" SelectCommand="SELECT [user_id], [full_name], [account_status], [email], [division], [city], [pincode] FROM [user_table]"></asp:SqlDataSource>
                     <div class="col">
